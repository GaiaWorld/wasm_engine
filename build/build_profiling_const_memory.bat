...
C:\Users\Administrator\.cargo\bin\\wasm-bindgen.exe target/wasm32-unknown-unknown/release/wasm_engine.wasm --out-dir pkg_profiling_const_memery --typescript --target web --out-name wasm_engine
